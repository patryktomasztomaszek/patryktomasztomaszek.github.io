...
const player = new Vimeo.Player(iframe); // Setting current video playtime from local storage

player.setCurrentTime(localStorage.getItem("videoplayer-current-time")); // initalizing listener for video playtime saving function
