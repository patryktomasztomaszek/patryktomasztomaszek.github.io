...
console.log(_galleryItems.galleryItems); // Assigning [div class="gallery"] position in variable

const gallery = document.querySelector(".gallery"); // Function for mappping of sourced data, and creating HTML markup for each image

const imagesHTML = imagesArray => imagesArray.map(({
  original,
  preview,
  description
}) => `
        ...
        `).join(""); // Executing function using sourced images data - injecting HTML markup


gallery.insertAdjacentHTML("beforeend", imagesHTML(_galleryItems.galleryItems));
console.log(gallery); // Init of SimpleLightbox library
